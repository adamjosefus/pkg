 ...
 */
async function installPackage(root: string, repo: RepositoryType, tokens: TokenType[], updateNpmConfig: boolean, installNpmModules: boolean, ignore: string[], checkConfigVersion: boolean) {
...
async function installPackages(root: string, repositories: Readonly<RepositoryType>[], tokens: TokenType[], updateNpmConfig: boolean, installNpmModules: boolean, ignore: string[], checkConfigVersion: boolean) {
    ...
    for (const repo of repositories) {
        await installPackage(root, repo, tokens, updateNpmConfig, installNpmModules, ignore, checkConfigVersion);
    }
}
